...
class AutoShape(nn.Module):
    ...
    classes = [0, 10, 24, 25, 26, 27, 28, 30, 31, 35, 39, 41, 43, 48, 63, 64, 65, 66, 67, 73, 76]  # (optional list) filter by class, i.e. = [0, 15, 16] for COCO persons, cats and dogs
...
class Detections:
    ...
    def pandas(self):
        ...
        cb = 'relative_x_center', 'relative_y_center', 'box_width', 'box_height', 'confidence', 'class', 'label_Id'  # xywh columns
