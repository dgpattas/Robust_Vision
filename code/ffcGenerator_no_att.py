...
class FFC_generator(nn.Module):
    def __init__(self,  norm='bn', depth_enc=False, upsample_mode='upsample', resblocks = 9, ngf=16, use_attention = False, predict_transm=True):
        super().__init__()
        self.upsample_mode = upsample_mode
        self.predict_transm = predict_transm
        self.depth_enc = depth_enc
        self.use_attention = True if  use_attention == 'with' else False
